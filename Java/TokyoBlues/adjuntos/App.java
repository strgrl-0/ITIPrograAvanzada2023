...
public class App {
	...
	public static void iniciarSesion(ListaUsuarios listaUsuarios,ListaProgamadores listaProgamadores,ListaIa listaIa,ListaDebilidades listaDebilidades,ListaPaises listaPaises){
		...
		String usernameAdmin = "EMPANADASCONCHAPALELE";
		String contraseñaAdmin = "SURICATARABIOSA";

		if(nombreUsuario.equals(usernameAdmin) && contrasenaUsuario.equals(contraseñaAdmin)){
